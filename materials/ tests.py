...
class LessonTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.lesson_2 = Lesson.objects.create(
            ...
            description="Второй тестовый урок"
        )
    ...
    def test_lesson_update(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.json().get("video_link"), "https://www.youtube.com/...")
...
class CourseSubscriptionTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.course_2 = Course.objects.create(
            ...
            description="Второй тестовый курс"
        )
    ...
    def test_course_update(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.json().get("description"), "Обновленное описание")
